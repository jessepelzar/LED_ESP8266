...
String getMusicOption() { // music
  return String(musicOption);
}
...
FieldList fields = {
  ...
  { "music", "Music Mode", BooleanFieldType, 0, 1, getMusic }, // music 
  { "musicOption", "Music Mode Option", BooleanFieldTypeTwo, 0, 1, getMusicOption }, // music 
